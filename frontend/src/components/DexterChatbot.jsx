...
function ChatInterface() {
  ...
  const { generateContent, isGenerating, generatedResponse, clearResponse } = useGeminiStore();
      ...
      <div className="hidden lg:flex lg:w-1/3 bg-gradient items-center justify-center p-6">
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          <div className="absolute bottom-8 text-center px-4">
            <h2 className="text-2xl font-bold text-white drop-shadow-lg">Dexter</h2>
            <p className="text-white opacity-80 drop-shadow-md">America’s favorite serial killer — with a code and a killer sense of cleanliness</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex-1 overflow-y-auto mb-4 bg-base-100 rounded-box shadow-lg p-4 h-full">
            {filteredMessages.length > 0 ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-base-content opacity-50">
                ...
                <p className="text-lg font-medium">Start a conversation with Dexter</p>
                <p className="text-sm mt-2">Ask anything if you have courage</p>
              </div>
            )}
          </div>
